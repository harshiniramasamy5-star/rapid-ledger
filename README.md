...
1. [What is RAPID Ledger?](#1-what-is-rapid-ledger)
2. [The RAPID Framework](#2-the-rapid-framework)
3. [Architecture](#3-architecture)
4. [Tech Stack](#4-tech-stack)
5. [Features](#5-features)
6. [Decision Workflow](#6-decision-workflow)
...
**RAPID Ledger** — *Because governance deserves better than a Slack thread.*
